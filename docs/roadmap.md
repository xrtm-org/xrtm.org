...
| **Local product spine** | Hub at `/` and `/hub`, Studio at `/studio`, forecast-path-linked Playground, Observatory run inspection, and `/workbench` compatibility on the deterministic baseline. | **DONE in 0.8.7** |
