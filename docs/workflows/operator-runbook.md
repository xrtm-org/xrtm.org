...
- the released WebUI shell (`/`, `/runs`, `/workbench`) for overview, run review, guided draft flow, and compare
...
API, reusable workflows stay on disk, and draft values plus validation/compare
resume state stay in SQLite on your machine.
