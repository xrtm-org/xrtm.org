...
The released `xrtm 0.8.8` surface does **not** ship built-in user management, centralized permissions, a multi-user control plane, or a full persistent collaborative canvas layout.

## Released sandbox note

The released `0.8.8` surface includes the bounded forecast-path-linked
