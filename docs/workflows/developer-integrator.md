...
- **Product workflow and artifact contract**: start with the [`xrtm` README](https://github.com/xrtm-org/xrtm) and [Getting started](../getting-started). The current released product shell is `xrtm 0.3.3`.
...
3. Move to the owning repo only after the released product path is clear.
