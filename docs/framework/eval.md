...
## Benchmark score ownership

In the benchmark stack, `xrtm-eval` owns the question **"how should this run be
judged?"**
...
- cohort comparisons
- leaderboard-ready metric math

It should not own corpus ingestion or replay orchestration.
