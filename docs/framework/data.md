...
## Benchmark corpus layer

For benchmark work, `xrtm-data` owns the source-of-truth registry for corpora:

- corpus IDs and versions
- provenance and license metadata
- release-gate approval state
- bundled versus cached versus preview source modes
- canonical question records with zero-leakage `snapshot_time`

This keeps benchmark admissibility decisions in the lowest layer that can own
them safely.
